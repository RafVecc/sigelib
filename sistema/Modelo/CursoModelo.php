...
class CursoModelo extends Modelo
{
    ...
    /**
     * Busca o tipo de usuário pelo ID
     * @return EntidadeModelo|null
     */
    public function entidadeCurso(): ?EntidadeModelo
    {
        if ($this->entidade_id) {
            return (new EntidadeModelo())->buscaPorId($this->entidade_id);
        }
        return null;
    }
    ...
    /**
     * Busca o tipo de usuário pelo ID
     * @return EspecializacaoModelo|null
     */
    public function especializacaoCurso(): ?EspecializacaoModelo
    {
        if ($this->especializacao_id) {
            return (new EspecializacaoModelo())->buscaPorId($this->especializacao_id);
        }
        return null;
    }
