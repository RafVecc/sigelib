...
class AdminTeste extends AdminController
{
    ...
    public function listar(): void
    {
        ...
        $preco = "https://west.albion-online-data.com/api/v2/stats/prices/";

        $lista_itens = ['T5_PLANKS', 'T5_PLANKS_LEVEL1@1'];
        $iten = 'T5_PLANKS_LEVEL1@1';

        $local = 'Martlock';

        $url_final = $preco . $iten . '.json?&locations=' . $local;

        $json = file_get_contents($url_final);
        ...
        echo $this->template->renderizar('teste/listar.html', [
    ...
    public function cadastrar(): void
    {
        ...
        $navegador = new BrowserDetection();
        $result = $navegador->getAll($_SERVER['HTTP_USER_AGENT']);
        var_dump($result);
        var_dump($result['browser_name']);die;
